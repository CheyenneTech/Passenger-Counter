...
function save() {
 ...
 // (1) In the above I created the previous entries by creating a new variable 'prevEntry' and setting that to = the count + the dash that will be between the numbers (" - "). I took the html id element "saveEl" combined with .textContent
